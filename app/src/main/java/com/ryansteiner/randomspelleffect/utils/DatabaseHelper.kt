...
/**
 * Code from https://medium.com/@johann.pardanaud/ship-an-android-app-with-a-pre-populated-database-cd2b3aa3311f
 */
...
class DatabaseHelper(val context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    private fun installOrUpdateIfNecessary() {
        ...
        //TODO I'll want to reimplement the version check for release
        context.deleteDatabase(DATABASE_NAME)
        installDatabaseFromAssets()
        writeDatabaseVersionInPreferences()
    }
    ...
    companion object {
        const val DATABASE_NAME = "spelleffectsdatabase.db"
