...
import com.ryansteiner.randomspelleffect.data.SpellEffectDatabase;
...
/**
 * Code from https://android.jlelse.eu/room-persistence-library-with-pre-populated-database-5f17ef103d3d
 */
public class DatabaseCopier {
    private static final String TAG = DatabaseCopier.class.getSimpleName();
    private static final String DATABASE_NAME = "databases/spelleffectsdatabase.db";

    private SpellEffectDatabase mAppDataBase;
    ...
    private DatabaseCopier() {
        ...
        mAppDataBase = Room.databaseBuilder(appContext,
                SpellEffectDatabase.class, DATABASE_NAME)
                //.addMigrations(MIGRATION_1_2)
                .build();
    }

    public SpellEffectDatabase getRoomDatabase() {
        return mAppDataBase;
    }
